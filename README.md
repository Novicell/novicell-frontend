...
_"I'll take care of minifiyng the images, scripts, styles and icons.
Now you just focus on doing what you do best: CODE!"_
...
Third party javascript plugins like `angular` or `owl-carousel` is handled by _[NPM](https://www.npmjs.com/)_.
