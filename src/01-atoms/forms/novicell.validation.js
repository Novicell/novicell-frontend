 ...
 * @desc A script that inits validate.js with default Novicell settings (validate is not maintaining the module anymore)
 * @author Bjørn Nyborg (BNY)
 * @example <form data-validate>
 * @requires https://github.com/cferdinandi/validate
 */

// import('validate/dist/validate.polyfills.min.js').then(function() {
//     validate.init({
